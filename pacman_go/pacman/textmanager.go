...
func (tm *textManager) showEntranceAnim(screen *ebiten.Image) {
	...
	if tm.count <= 60 {
		...
		text.Draw(screen, startText, tm.entranceFF, 7*stageBlocSize, 5*stageBlocSize, gold)
	} else {
...
func (tm *textManager) draw(screen *ebiten.Image, score, lives int, pac *ebiten.Image, won bool) {
	...
	text.Draw(screen, wText, tm.bodyFF, tm.keyX, tm.titleY+2*stageBlocSize, gold)
...
func (tm *textManager) livesPosition(l int) (x, y float64) {
